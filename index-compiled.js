...
/********************************************/
var candy = 'cremeEgg';
var cadbury = defineProperty({}, candy, 'for sale now');
...
var Human = function (_Animal) {
  inherits(Human, _Animal);

  function Human() {
    classCallCheck(this, Human);
    return possibleConstructorReturn(this, (Human.__proto__ || Object.getPrototypeOf(Human)).apply(this, arguments));
  }
  ...
  createClass(Human, [{
    ...
    value: function iWantThreeLegs() {
      ...
      get(Human.prototype.__proto__ || Object.getPrototypeOf(Human.prototype), 'addOneMoreLeg', this).call(this);
    }
  }, {
    ...
    value: function iWantToLiveOnJupiter() {
      ...
      get(Human.prototype.__proto__ || Object.getPrototypeOf(Human.prototype), 'isThisAGoodExample', this).call(this);
    }
  }]);
  return Human;
}(Animal);
...
var someName = defineProperty({}, Symbol.iterator, function () {
  return {
    items: ['well', 'ok', 'then'],
    next: function next() {
      return {
...
(_console = console).log.apply(_console, toConsumableArray(someName));
...
function someGenerator() {
  return regeneratorRuntime.wrap(function someGenerator$(_context) {
    while (1) {
...
var generatorObject = someGenerator();
...
// and yeah
console.log([].concat(toConsumableArray(generatorObject)));
...
var generateStuffThx = anotherGenerator();
var _iteratorNormalCompletion2 = true;
var _didIteratorError2 = false;
var _iteratorError2 = undefined;

try {
  for (var _iterator2 = generateStuffThx[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
